...
/**
 * Copié depuis les extras de Gson.
 * Permet de gérer la (dé)sérialisation polymorphique.
 */
        ...
        return new TypeAdapter<R>() {
            ...
            public R read(JsonReader in) throws IOException {
                ...
                if (labelJsonElement == null) {
                    throw new JsonParseException("Missing type field \"" + typeFieldName + "\" in: " + jsonObject);
                }
